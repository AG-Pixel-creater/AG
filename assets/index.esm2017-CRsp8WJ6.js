import{r as R,_ as k,C as y,l as N,E as z,G as W,F as X}from"./index.esm2017-BSwLSc3b.js";const P="@firebase/installations",T="0.6.9";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G="installations",qt="installations-internal",vt=t=>{const e=t.getProvider("app").getImmediate(),n=_t(e),r=N(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},jt=t=>{const e=t.getProvider("app").getImmediate(),n=N(e,G).getImmediate();return{getId:()=>Nt(n),getToken:o=>Pt(n,o)}};function Ft(){k(new y(G,vt,"PUBLIC")),k(new y(qt,jt,"PRIVATE"))}Ft();R(P,T);R(P,T,"esm2017");
