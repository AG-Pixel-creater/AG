import{h as o,o as S,p as D}from"./firebase-config-DR-0WxIp.js";/* empty css                 */import{g as $,q as u,c as g,b as p,d as y,e as l,u as E,s as h,f as L,w as M,o as b,h as k}from"./index.esm2017-BUFHNJL2.js";const d=$();document.getElementById("messagesList");async function B(){try{if(await Notification.requestPermission()==="granted"){const a=await S(D,{vapidKey:"BOanVJq4Mf-4H8MXPLg-5GnuUwORDbxsvFxjXOEQEYJSIIu2sJCh85L-69I-GRPcwgALivkh_k2XH1eQfKu-bTo"});await h(l(d,"adminTokens",o.currentUser.uid),{token:a,email:o.currentUser.email,lastUpdated:new Date})}}catch(e){console.error("Error setting up notifications:",e)}}async function I(e){if(!e)return!1;if(e.email==="ag.aliengamerz@gmail.com")return!0;try{if(e.email==="hamza.datashare@gmail.com")return!0;const a=u(g(d,"admins"),M("email","==",e.email.toLowerCase()));return!(await p(a)).empty}catch(a){return console.error("Error checking admin status:",a),!1}}function U(){const e=u(g(d,"messages"),b("timestamp","desc")),a=document.getElementById("messagesList");if(!a){console.error("Messages list element not found");return}try{const n=k(e,i=>{if(a.innerHTML="",i.empty){a.innerHTML='<p class="no-messages">No messages yet</p>';return}i.forEach(t=>{var r,c;const s=t.data(),m=(c=(r=s.timestamp)==null?void 0:r.toDate)!=null&&c.call(r)?s.timestamp.toDate().toLocaleString():"No date";a.innerHTML+=`
